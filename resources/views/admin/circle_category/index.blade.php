...
<section class="content-header">
    <h1>
        圈子分类列表
        <small>圈子分类列表</small>
        <button type="button" class="btn btn-success btn-sm pull-right" onclick="javascript:window.location.href='{{url('admin/circle/category/add')}}'">增加</button>
    </h1>
</section>
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-xs" onclick="window.location.href='{{url('admin/circle/category/edit/'.$value['id'])}}'">编辑</button>

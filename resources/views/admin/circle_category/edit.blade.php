                ...
                <form class="form-horizontal" method="post" enctype="application/x-www-form-urlencoded" id="form-edit">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="category_name" id="goods_category_name" class="form-control" placeholder="分类名称" value="{{$category['category_name']}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <img style="width: 50px;height: 50px;" src="{{$category['img_url']}}">
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="admin_name" class="col-sm-2 control-label">分类描述</label>
                            <div class="col-sm-4">
                                <input type="text" name="description" id="description" value="{{$category['description']}}" class="form-control" placeholder="分类描述">
                            </div>
                            <div class="col-sm-4">
                                <span style="color: red;">* 必填</span>
                            </div>
        ...
        $('#form-edit').submit(function(){
            var options = {
                ...
                success: function (data) {
                    if (data.error == 0) {
                        alert('编辑成功');
                        window.location.href = '{{url('admin/circle/category')}}';
                    } else {
                        alert(data.message);
                    }
                }

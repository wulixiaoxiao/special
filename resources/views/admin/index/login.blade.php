...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <div class="form-group has-feedback">
                <input type="text" name="code" id="code" class="form-control" placeholder="验证码" style="width: 160px;display: inline-block;">
                <img src="{{url('admin/getVerifyCode')}}" alt="" style="display: inline-block;cursor: pointer;" id="verify_code">
            </div>
            <div class="row">
                <!-- /.col -->
...
<script>
    ...
    $('#verify_code').click(function() {
        var src = $(this).prop('src') + '?time='+Math.random();
        $(this).prop('src', src);
    });
    $('#btn-login').click(function() {
        ...
        $.post('/admin/login', {'admin_name' : admin_name, 'password' : password, 'code' : code}, function(data) {
            if (data.error == 0) {

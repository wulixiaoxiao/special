                    ...
                    <form class="form-horizontal form-inline form-group-sm" method="post" enctype="application/x-www-form-urlencoded">
                        ...
                        <label>返利状态:&nbsp;&nbsp;
                            <select class="form-control" name="status">
                                ...
                                <option value="3" @if($status == 3) selected @endif>已冻结</option>
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{CommonHelper::getInstance()->formatPriceToShow($value['rebate_price'])}}</td>
                            <td>{{$value['rebate_rate']}} %</td>
                            <td>{{$value['rebate_coin']}}</td>
                            <td>{{$value['coin_rate']}} %</td>
                            <td>
                                @if($value['status'] == 1)

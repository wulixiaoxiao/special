                ...
                <form class="form-horizontal" method="post" enctype="application/x-www-form-urlencoded" id="form-edit">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{$repairGoods['service_number']}}</div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{$repairGoods['order_sn']}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{$repairGoods['member_name']}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{$repairGoods['goods_name']}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ad_name" class="col-sm-2 control-label">返修数量</label>
                            <div class="col-sm-4">{{$repairGoods['goods_number']}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ad_name" class="col-sm-2 control-label">返修状态</label>
                            <div class="col-sm-4">
                                @if($repairGoods['status'] == 1)
                                    <span class="label label-danger">{{$repairGoods['status_text']}}</span>
                                @elseif($repairGoods['status'] == 2)
                                    <span class="label label-warning">{{$repairGoods['status_text']}}</span>
                                @elseif($repairGoods['status'] == 3)
                                    <span class="label label-default">{{$repairGoods['status_text']}}</span>
                                @elseif($repairGoods['status'] == 4)
                                    <span class="label label-primary">{{$repairGoods['status_text']}}</span>
                                @elseif($repairGoods['status'] == 5)
                                    <span class="label label-success">{{$repairGoods['status_text']}}</span>
                                @elseif($repairGoods['status'] == 6)
                                    <span>{{$repairGoods['status_text']}}</span>
                                @endif
                            </div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{date('Y-m-d H:i:s', $repairGoods['apply_time'])}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{$repairGoods['question']}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                @foreach($repairGoods['pic'] as $key => $value)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{$repairGoods['admin_name']}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">{{$repairGoods['status_note']}}</div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>
                        </div>
                        ...
                        @endif
                        @if($repairGoods['status'] != 3 && $repairGoods['status'] != 5 && $repairGoods['status'] != 6)
                        <div class="form-group">

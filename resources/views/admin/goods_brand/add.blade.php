                ...
                <form class="form-horizontal" method="post" enctype="application/x-www-form-urlencoded" id="form-add">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="goods_brand_name" id="goods_brand_name" class="form-control" placeholder="品牌名称">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="description" id="description" class="form-control" placeholder="品牌描述" value="">
                            </div>
                            <div class="col-sm-4">
                                <span style="color: red;">* 必填</span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="file" name="brandIcon" class="form-control" id="inputPassword3">
                            </div>
                            <div class="col-sm-4">
                                <span style="color: red;"></span>
                            </div>

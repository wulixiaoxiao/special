...
<section class="content-header">
    <h1>
        商品品牌列表
        <small>商品品牌列表</small>
        <button type="button" class="btn btn-success btn-sm pull-right" onclick="javascript:window.location.href='{{url('admin/goodsBrand/add')}}'">增加</button>
    </h1>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-xs" onclick="window.location.href='{{url('admin/goodsBrand/edit/'.$value['id'])}}'">编辑</button>
                ...
                <div class="box-footer clearfix">
                    ...
                    {!! with(new \App\Library\PageLibrary($brands))->render() !!}
                </div>
                <!-- /.box-footer -->
            </div>
            <!-- /.box -->
    ...
    <script>
        ...
        function del(id) {
            ...
            if (confirm('删除后不可恢复,确定要删除吗?')) {
                $.post('{{url('admin/goodsBrand/del')}}', {'id' : id}, function(data) {
                    if (data.error == 0) {
                        alert('删除成功');
